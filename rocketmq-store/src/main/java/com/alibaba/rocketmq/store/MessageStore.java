...
public interface MessageStore {
     ...
     * 根据消息Key查询消息
     */
    public QueryMessageResult queryMessage(final String topic, final String key, final int maxNum, final long begin, final long end);
     ...
     * 批量获取 messageId
     */
    public Map<String, Long> getMessageIds(final String topic, int queueId, long minOffset, final long maxOffset, SocketAddress storeHost);
