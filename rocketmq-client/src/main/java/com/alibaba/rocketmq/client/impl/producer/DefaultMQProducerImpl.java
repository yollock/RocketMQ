...
public class DefaultMQProducerImpl implements MQProducerInner {
        ...
        Runnable request = new Runnable() {
            ...
            public void run() {
                ...
                if (transactionCheckListener != null) {
                    ...
                    this.processTransactionState(localTransactionState,//
                            group, //
                            exception);
                } else {
    ...
    private SendResult sendKernelImpl(final Message msg,//
        ...
        if (brokerAddr != null) {
            ...
            try {
                ...
                SendResult sendResult = this.mQClientFactory.getMQClientAPIImpl().sendMessage(brokerAddr,// 1
                        mq.getBrokerName(),// 2
                        msg,// 3
                        requestHeader,// 4
                        timeout,// 5
    ...
    private SendResult sendSelectImpl(Message msg,//
